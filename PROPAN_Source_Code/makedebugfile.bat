...
del /q Code\*.* 2>nul
del /q ProPan2025_v1.0_debug.exe 2>nul
...
rem ===== Link to EXE =====
%FC% /nologo /Fe:ProPan2025_v1.0_debug.exe *.obj /link /STACK:16777216,65536 || goto :err

rem ===== Stage outputs =====
move /y *.obj Code >nul
move /y *.mod Code >nul 2>nul
move /y *_genmod.f90 Code >nul 2>nul
if exist ProPan2025_v1.0_debug.exe copy /y ProPan2025_v1.0_debug.exe Code >nul

echo.
echo Build succeeded: ProPan2025_v1.0_debug.exe
exit /b 0
