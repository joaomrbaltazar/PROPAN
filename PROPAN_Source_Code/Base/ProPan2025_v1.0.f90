...
!    Modified  : 11032022, J. Baltazar, 2022 version 1.0                                        !
!    Modified  : 24082025, J. Baltazar, 2025 version 1.0                                        !
!-----------------------------------------------------------------------------------------------!
PROGRAM PROPAN
!-----------------------------------------------------------------------------------------------!
!    Input Description                                                                          !
...
!    IV        =    Control variable for location of induced velocity points                    !
!                   IV=0: segment mean point                                                    !
!                   IV=1: mean cosine angle                                                     !
